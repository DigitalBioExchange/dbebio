...
if($total){
	...
	$sql = "select p.*, c1.ca_name as c1_name, c2.ca_name as c2_name from rb_product as p left join rb_cate as c1 on c1.ca_idx = p.c1_idx and c1.ca_step = 1 left join rb_cate as c2 on c2.ca_idx = p.c2_idx  and c2.ca_step = 2 where 1 $search_query $order_query $limit_query";
	$data = sql_list($sql);
